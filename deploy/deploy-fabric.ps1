<#
.SYNOPSIS
    Idempotent deployment of Spend Analyzer lakehouses, folders, and notebooks
...
Write-Host "`n=== Spend Analyzer -- Fabric Deployment ===" -ForegroundColor Cyan
...
function Ensure-FabricLakehouse {
    param([string]$WorkspaceId, [string]$LakehouseName, [string]$FolderId)
...
$dataFolderId      = Ensure-FabricFolder -WorkspaceId $workspaceId -FolderName "data"
...
$landingId = Ensure-FabricLakehouse -WorkspaceId $workspaceId -LakehouseName $config.fabric.landing_lakehouse -FolderId $dataFolderId
$bronzeId  = Ensure-FabricLakehouse -WorkspaceId $workspaceId -LakehouseName $config.fabric.bronze_lakehouse  -FolderId $dataFolderId
$silverId  = Ensure-FabricLakehouse -WorkspaceId $workspaceId -LakehouseName $config.fabric.silver_lakehouse  -FolderId $dataFolderId
$goldId    = Ensure-FabricLakehouse -WorkspaceId $workspaceId -LakehouseName $config.fabric.gold_lakehouse    -FolderId $dataFolderId
